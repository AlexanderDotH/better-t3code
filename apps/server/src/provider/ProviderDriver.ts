 ...
 * (`ProviderInstance`) is also a record — captured runtime/history facets
 * (`snapshot`, `adapter`, `historySync`, `textGeneration`), an id, and a driver kind. There
 ...
 *
 * The runtime and history facets are captured closures owned by this instance —
