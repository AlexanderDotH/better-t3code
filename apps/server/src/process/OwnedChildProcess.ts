...
/**
 * Sends SIGKILL through the exact captured child handle. The process backend
 * targets that owned process group and the result is verified against the
 * same handle, never by a process-name or path lookup.
 */
