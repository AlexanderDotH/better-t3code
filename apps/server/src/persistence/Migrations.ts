...
import Migration0033 from "./Migrations/033_ProjectSpeechProfiles.ts";
import Migration0034 from "./Migrations/034_ProjectionThreadSubagents.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectSpeechProfiles", Migration0033],
  [34, "ProjectionThreadSubagents", Migration0034],
] as const;
