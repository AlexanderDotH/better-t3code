      ...
      <div className={cn("flex min-w-0 items-center gap-1", className)}>
        ...
        >
          ...
          >
            ...
            <span
              data-composer-label
              className="min-w-0 max-w-[180px] truncate transition-[max-width,opacity] duration-300 ease-out group-data-[compact]/composer-context:max-w-0 group-data-[compact]/composer-context:opacity-0"
            >
              {triggerLabel}
            </span>
