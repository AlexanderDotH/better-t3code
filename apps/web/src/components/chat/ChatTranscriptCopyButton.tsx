...
export const ChatTranscriptCopyButton = memo(function ChatTranscriptCopyButton({
  ...
  const handleCopy = useCallback(async () => {
    if (requestInFlightRef.current || activeTurnInProgress) return;
  ...
  }, [activeTurnInProgress, environmentId, threadId]);

  const disabled = activeTurnInProgress || state !== "idle";
  const tooltip = activeTurnInProgress
