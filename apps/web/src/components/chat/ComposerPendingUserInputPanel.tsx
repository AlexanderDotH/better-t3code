...
export function pendingUserInputDisclosureMessageId(collapsed: boolean): InterfaceMessageKey {
  return collapsed
  ...
  return (
    ...
    >
      <CollapsibleTrigger
        ...
        title={translate(pendingUserInputDisclosureMessageId(isCollapsed))}
