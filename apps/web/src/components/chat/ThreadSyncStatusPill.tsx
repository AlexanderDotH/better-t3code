...
export function ThreadSyncStatusPill({ phase }: { readonly phase: ThreadSyncPhase }) {
  ...
  return (
    <div
      aria-label={label}
      className="chat-composer-drawer-surface chat-composer-drawer-floating chat-composer-drawer-slot pointer-events-none flex items-center gap-2 px-3 py-2 text-foreground text-xs font-medium sm:px-4"
