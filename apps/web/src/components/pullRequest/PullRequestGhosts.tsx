...
export function PullRequestListGhost({
  ...
  return (
    <div
      role="status"
      aria-label={caption ?? translate("pullRequest.loading")}
...
export function PullRequestDetailGhost() {
  ...
  return (
    <div
      role="status"
      aria-label={translate("pullRequest.loading")}
...
export function PullRequestPeopleGhost({ rows = 4 }: { rows?: number }) {
  ...
  return (
    <div
      role="status"
      aria-label={translate("pullRequest.loading.people")}
...
export function PullRequestTimelineGhost({ rows = 6 }: { rows?: number }) {
  ...
  return (
    <div
      role="status"
      aria-label={translate("pullRequest.loading.timeline")}
...
export function PullRequestConversationGhost({ rows = 3 }: { rows?: number }) {
  ...
  return (
    <div
      role="status"
      aria-label={translate("pullRequest.loading.conversation")}
