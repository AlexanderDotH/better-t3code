...
// Both web sidebar presentations consume the same sort contract. Keeping the
// preference at this seam prevents the current and Classic layouts from
// silently assigning different orders to the same thread collection.
