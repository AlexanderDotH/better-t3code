...
export const DesktopConfig = Config.all({
  ...
  desktopDisplayNameOverride: trimmedString("T3CODE_DESKTOP_DISPLAY_NAME"),
  appUserModelIdOverride: trimmedString("T3CODE_DESKTOP_APP_USER_MODEL_ID"),
  desktopUserDataDirNameOverride: trimmedString("T3CODE_DESKTOP_USER_DATA_DIR_NAME"),
  desktopLegacyUserDataDirNameOverride: trimmedString("T3CODE_DESKTOP_LEGACY_USER_DATA_DIR_NAME"),
  desktopLinuxEntryNameOverride: trimmedString("T3CODE_DESKTOP_LINUX_DESKTOP_ENTRY_NAME"),
  desktopLinuxWmClassOverride: trimmedString("T3CODE_DESKTOP_LINUX_WM_CLASS"),
