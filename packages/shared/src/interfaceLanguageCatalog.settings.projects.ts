...
export const settingsProjectsInterfaceCatalog = defineLocalizedInterfaceCatalog({
  ...
  "settings.projects.memory.source.off": ["Off", "Aus", "Désactivée"],
  "settings.projects.memory.allowAgentWrites": [
    "Allow agent writes",
    "Schreibzugriff für Agents erlauben",
    "Autoriser les agents à écrire",
  ],
  "settings.projects.memory.allowAgentWritesDescription": [
    "Let agents update this project's memory file.",
    "Agents dürfen die Speicherdatei dieses Projekts aktualisieren.",
    "Autorisez les agents à mettre à jour le fichier mémoire de ce projet.",
  ],
  "settings.projects.memory.effectiveFile": [
    "Effective memory file",
    "Effektive Speicherdatei",
    "Fichier mémoire effectif",
  ],
  "settings.projects.memory.noFile": [
    "No memory file is available.",
    "Keine Speicherdatei ist verfügbar.",
    "Aucun fichier mémoire n’est disponible.",
  ],
  "settings.projects.memory.status.ready": ["Ready", "Bereit", "Prêt"],
  "settings.projects.memory.status.fallback": [
    "Using T3 home fallback",
    "T3-Home-Fallback wird verwendet",
    "Utilisation du repli T3 Home",
  ],
  "settings.projects.memory.status.unavailable": ["Unavailable", "Nicht verfügbar", "Indisponible"],
  "settings.projects.memory.content": [
  ...
  "settings.projects.memory.clear": ["Clear", "Leeren", "Effacer"],
  "settings.projects.memory.save": ["Save", "Speichern", "Enregistrer"],
  "settings.projects.memory.clearTitle": [
    "Clear project memory?",
    "Projektspeicher leeren?",
    "Effacer la mémoire du projet ?",
  ],
  "settings.projects.memory.clearDescription": [
    "This deletes the current project memory content and cannot be undone.",
    "Dadurch wird der aktuelle Projektspeicher unwiderruflich gelöscht.",
    "Cette action supprime le contenu actuel de la mémoire du projet et ne peut pas être annulée.",
  ],
  "settings.projects.memory.clearAction": ["Clear memory", "Speicher leeren", "Effacer la mémoire"],
  "settings.projects.memory.filename": ["MEMORY.md", "MEMORY.md", "MEMORY.md"],
