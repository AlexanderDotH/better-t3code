...
const betterT3SettingsCatalog = defineLocalizedInterfaceCatalog({
  ...
  "settings.betterT3.reasoning.working": [
    "In Working dialog",
    "Im Working-Dialog",
    "Dans la bulle de travail",
  ],
  "settings.betterT3.reasoning.none": [
    "No thinking traces",
    "Keine Thinking-Traces",
    "Aucune trace de raisonnement",
  ],
  "settings.betterT3.reasoning.chat": ["In chat", "Im Chat", "Dans la discussion"],
  "settings.betterT3.preview.reasoning.previous": [
    "Reading the relevant files",
    "Relevante Dateien lesen",
    "Lecture des fichiers concernés",
  ],
  "settings.betterT3.preview.reasoning.current": [
...
const featureLabels = {
  ...
  "agent.reasoningVisibility": [
    ...
    "Darstellung der Thinking-Traces",
    "Affichage des traces de raisonnement",
  ],
...
const featureDescriptionOverrides: Partial<Record<BetterT3FeatureId, FeatureLabel>> = {
  ...
  "agent.reasoningVisibility": [
    "Hide thinking traces, keep the full traces in chat, or follow live thoughts in the Working dialog. Uses your character streaming setting.",
    "Thinking-Traces ausblenden, vollständig im Chat lesen oder live im Working-Dialog verfolgen. Nutzt deine Character-Streaming-Einstellung.",
    "Masquez les traces de raisonnement, lisez-les dans la discussion ou suivez-les en direct dans la bulle de travail. Utilise votre animation de texte.",
  ],
  "agent.reasoningWorkingOverlay": [
    "Follow live thoughts in the Working overlay as scrolling lyrics, or keep the full traces in chat. Uses your character streaming setting.",
    "Live-Gedanken im Working-Overlay als Lyrics-Scroller verfolgen oder die vollständigen Traces im Chat behalten. Nutzt deine Character-Streaming-Einstellung.",
    "Suivez les pensées en direct dans la bulle de travail comme des paroles défilantes, ou conservez les traces complètes dans la discussion. Utilise votre animation de texte.",
  ],
  "chat.messageEditing": [
    "Edit user and assistant messages directly in the chat. Your next message uses the corrected conversation.",
    "Nutzer- und Agentennachrichten direkt im Chat bearbeiten. Die nächste Nachricht verwendet den korrigierten Verlauf.",
    "Modifiez les messages utilisateur et assistant dans la discussion. Votre prochain message utilise la conversation corrigée.",
  ],
  "chat.sidebarPosition": [
