...
export const BETTER_T3_FEATURE_REGISTRY = [
  ...
  descriptor({
    id: "agent.reasoningWorkingOverlay",
    section: "agent-workflows",
    scope: "device",
    controlKind: "switch",
    surfaces: ["web", "desktop"],
    dependencies: [{ featureId: "agent.reasoningVisibility", condition: "enabled" }],
  }),
  descriptor({
  ...
  descriptor({
    ...
    scope: "environment",
    controlKind: "switch",
    capabilities: [capability("knowledgeGraphVersion", 2)],
  }),
  descriptor({
    ...
    controlKind: "switch",
    capabilities: [
      capability("projectIndexingVersion", 3),
      capability("projectIndexingDefaultsVersion", 1),
    ],
    mirrors: [serverMirror("projectIndexingEnabled")],
  }),
  descriptor({
  ...
  descriptor({
    ...
    scope: "project",
    controlKind: "link",
    capabilities: [capability("projectIndexingVersion", 3)],
    mirrors: [{ store: "project-settings", path: "projectIndexing", access: "deep-link" }],
  }),
  descriptor({
