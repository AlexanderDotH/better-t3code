...
import {
  ...
  type ForceAbortThreadTurnInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    forceAbortTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:force-abort-turn",
      execute: (input: ForceAbortThreadTurnInput) => forceAbortThreadTurn(input),
      scheduler,
      concurrency,
    }),
