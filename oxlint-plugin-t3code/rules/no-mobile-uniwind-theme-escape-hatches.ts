...
const THEME_INTEROP_ALLOWLIST = new Set([
  ...
  "features/settings/HarnessChatSyncSettings.tsx",
  "features/settings/MobileProviderSettingsForm.tsx",
  "features/settings/SettingsAgentEnvironmentsRouteScreen.tsx",
  ...
  "features/threads/ThreadSubagentStack.tsx",
