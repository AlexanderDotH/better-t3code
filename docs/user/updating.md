...
| Action                     | What to do                                                                                                                                                                  |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Update server**          | Available for the T3 Code Linux, macOS, or Windows background service. Select the button and leave T3 Code open while it prepares, tests, restarts, and reconnects.         |
