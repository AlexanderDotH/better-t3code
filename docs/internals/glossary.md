...
The backend agent runtime that actually performs work. Six drivers ship built in: Codex, Claude, Cursor, Grok, OpenCode, and Gemini. See [ProviderService.ts][14], [ProviderAdapter.ts][15], and [CodexAdapter.ts][17] as a representative adapter.
...
- [Permission modes][18]
- [Workspace layout][2]
- [Internal provider MCP][25]
- [MCP configuration and runtime status][26]
- [MCP servers][29]
- [Git workbench][27]
